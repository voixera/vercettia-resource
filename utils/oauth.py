...
DEFAULT_RULES = [
    "Wajib membaca dan mengikuti seluruh rules server.",
    "Dilarang spam, scam, toxic, atau promosi tanpa izin.",
    "Gunakan ticket untuk order, kendala payment, dan bantuan produk.",
    "Semua transaksi wajib melalui channel dan payment resmi Vercettia Store.",
]
